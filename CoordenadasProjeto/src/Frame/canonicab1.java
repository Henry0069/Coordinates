...
public class canonicab1 extends JFrame  implements ActionListener
{
	...
	public canonicab1()
	{
		...
		// LABEL ALPHA
		l5 = new JLabel("Digite o X canonica:");
		l5.setSize(185,20);
		...
		// LABEL BETA
		l6 = new JLabel("Digite o Y canonica:");
		l6.setSize(185,20);
		...
		tx5 = new JTextField("");
		tx5.setSize(250,30);
		tx5.setLocation(140,230);
		getContentPane().add(tx5);
		
		//TEXT FIELD 6
		tx6 = new JTextField("");
		tx6.setSize(250,30);
		tx6.setLocation(140,265);
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if (e.getSource() == calcular)
		{
			...
			d = (Double.parseDouble(tx1.getText()) * Double.parseDouble(tx4.getText())) + ((Double.parseDouble(tx2.getText()) * Double.parseDouble(tx3.getText()))*-1); 
			dX = (Double.parseDouble(tx6.getText()) * Double.parseDouble(tx3.getText())) + ((Double.parseDouble(tx4.getText()) * Double.parseDouble(tx5.getText()))*-1);
			dY = (Double.parseDouble(tx1.getText()) * Double.parseDouble(tx6.getText())) + ((Double.parseDouble(tx2.getText()) * Double.parseDouble(tx5.getText()))*-1);
